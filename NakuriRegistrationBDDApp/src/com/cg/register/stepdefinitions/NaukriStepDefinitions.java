...
private WebDriver driver;
	...
	public void user_is_on_Nakuri_com_web_site() throws Throwable {
		driver=new ChromeDriver();
		 driver.get("https://my.naukri.com/account/createaccount");
	}

	@When("^user selects on Register with us And selects I am a Frseher$")
	public void user_selects_on_Register_with_us_And_selects_I_am_a_Frseher() throws Throwable {
	 
	}

	@Then("^freshers Registration should display$")
	public void freshers_Registration_should_display() throws Throwable {
	...
	public void user_selects_I_am_a_Frseher() throws Throwable {
		WebElement searchField=driver.findElement(By.xpath("/html/body/div/form/div[1]/div/div"));
		Thread.sleep(2000);
		searchField.click();
	}
